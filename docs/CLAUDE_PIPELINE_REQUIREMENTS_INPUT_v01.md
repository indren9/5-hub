...
- **domanda/prossimità logistica-industriale** — baseline dati ACCEPTED con DEC-0079: `LOGISTICS_FVG_v02.gpkg / LOGISTICS_FVG_POINTS`, 26 `SITE_ID` POINT EPSG:32632; per ogni candidato si costruisce la matrice completa delle 26 distanze point-to-polygon. Nessuna soglia, peso, bonus o aggregazione in score è ancora approvata; `SITE_ID 25 — ZIMA` mantiene `NEEDS_HUMAN_CHECK`;
