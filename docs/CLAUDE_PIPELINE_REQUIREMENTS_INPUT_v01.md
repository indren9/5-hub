...
- **PGRA / alluvioni** — ACCEPTED IN PRINCIPLE con DEC-0082 come criterio numerico separato: classi PGRA ordinate dalla meno critica alla più critica, trasformate in valori normalizzati 0–1; score candidato come media pesata per superficie delle classi intersecate. La mappatura concreta classe→score resta da chiudere dopo verifica delle classi effettivamente disponibili nel layer operativo;
