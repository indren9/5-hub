# FASE 1 — Definizione Hub Energetico Green — REBASELINED v03 — PROPOSED

**Chat:** 0.3 — Re-baseline strategica e semplificazione metodologica
**Data:** 2026-09-21
**Stato:** PROPOSED — non sostituisce la v02 FROZEN finché l'utente non approva
**Predecessore preservato:** FASE_1_HUB_DEFINITION_CONSOLIDATED_v02.md — FROZEN
**Autorità della proposta:** DEC-0061 ACCEPTED
...
Questo documento propone quindi una nuova baseline di Fase 1 senza modificare retroattivamente la v02.

## 2. Elementi che restano invariati

Restano integralmente validi F1-D1…F1-D7:
...
Non sono requisiti per chiudere il modello:
...
- DEC-0006…DEC-0012 / F1-D1…F1-D7: **KEEP**.
- DEC-0013: resta la decisione storica di freeze della v02; **non viene modificata**.
- DEC-0061: giustifica il successore v03 e la separazione fra requisiti funzionali e due diligence.
...
Questa v03 è esclusivamente **PROPOSED**.

Se approvata esplicitamente dall'utente:
1. diventa il successore metodologico della v02 per il nuovo scope;
2. la v02 resta preservata come baseline FROZEN storica;
3. la Chat Madre registra la relazione di supersessione senza riscrivere le decisioni originarie.

Nessuna Fase 4 viene aperta da questo documento.
