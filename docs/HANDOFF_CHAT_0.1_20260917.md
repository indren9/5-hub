...
> **Nota di governance successiva (2026-09-18):** il percorso `C:\Tesi\dev` qui riportato descrive correttamente lo stato al momento della Chat 0.1, ma è stato successivamente **SUPERSEDED**. Il repository ufficiale è stato migrato in `C:\dev\5-hub` su approvazione dell’utente; riferimento: DEC-0014 e `docs/ARCHITECTURE_MIGRATION_20260918.md`. Anche la cartella OneDrive `project_storage` riportata nello storico è stata successivamente rinominata in `5_HUB_FVG`; riferimento: DEC-0018.
