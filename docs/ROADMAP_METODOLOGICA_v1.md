...
- Attività corrente: l'urbanistica non è più un blocker della futura Fase 4 grazie a DEC-0048; la baseline urbanistica di screening è `READY_WITH_LIMITATIONS`, con proxy espliciti e verifica corrente obbligatoria sui finalisti. Restano da chiudere gli altri blocchi della Fase 3 — routing Light/Heavy, energia, dati di domanda e gap tecnici/dati già tracciati. La Fase 4 non è ancora formalmente aperta finché la Fase 3 complessiva non è PASS/CLOSED.
