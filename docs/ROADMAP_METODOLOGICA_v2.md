# ROADMAP METODOLOGICA v2 — ACCEPTED / OPERATIVE

**Chat:** 0.3 — Re-baseline strategica e semplificazione metodologica
**Data:** 2026-09-21
**Stato:** ACCEPTED / OPERATIVE — approvata esplicitamente dall'utente il 2026-09-21
**Autorità:** DEC-0061 ACCEPTED
**Vincolo:** l'apertura operativa di ciascuno stadio richiede il relativo dispatch; DQ-01…DQ-10 restano decisioni separate e non sono approvate dalla roadmap.
...
ROADMAP_METODOLOGICA_v1.md → **DEPRECATED / HISTORICAL_BASELINE**.
...
- **Fase 3:** **PASS / CLOSED WITH DECLARED LIMITATIONS** con DEC-0063. I gap diventati post-model non restano blocker del core.
