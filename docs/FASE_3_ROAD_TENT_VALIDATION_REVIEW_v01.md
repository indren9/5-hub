# FASE 3 â€” Rete stradale, accessi e TEN-T â€” Review Chat 3.3

**Chat:** 3.3 â€” Rete stradale, accessi e TEN-T
**Data:** 2026-09-18
**Stato documento:** REVIEW
**Esito Chat 3.3:** PASS tecnico-operativo con gap esplicitamente delimitati
**FASE 3:** IN CORSO â€” non CLOSED, non FROZEN
**Regia metodologica:** Chat Madre 5 HUB

## 1. Scopo e confini

Il mandato Ã¨ verificare e delimitare con evidenza ISS-0004 e ISS-0005 prima della costruzione dei candidati.

La chat non costruisce candidati, accessi reali, road anchor reali, connettori candidatoâ€“rete, exit set TEN-T operativo, indicatori, punteggi o ranking.
...
Il punto rappresentativo del candidato non Ã¨ un accesso e non Ã¨ origine implicita del routing.

## 2. Fonti e baseline verificate

Baseline locali:
- docs/FASE_1_HUB_DEFINITION_CONSOLIDATED_v02.md â€” FROZEN;
- docs/FASE_2_UNIT_ANALYSIS_CONSOLIDATED_v01.md â€” FROZEN;
...
- ISS-0004 e ISS-0005 risultavano OPEN allâ€™avvio.
...
- fonti ufficiali dei gestori per evidenza dellâ€™esistenza di restrizioni Heavy dinamiche.

## 3. Grafo stradale FVG â€” snapshot e schema
...
Lo schema include, tra gli altri: CLASSE, ENTE_GESTORE, DIR, ENTEXT, TRIM_USAGE_ALLOWANCE, TRIM_LANES, GEOMETRY_REVERSED, FONTE_INT e campi di validitÃ .

La lineage interna non Ã¨ omogenea. FONTE_INT include CTRN, Catasto Strade, TeleAtlas, Autovie Venete, OSM e altre fonti. Il grafo va quindi trattato come integrazione regionale e non come rilievo monolitico con qualitÃ  uniforme.

## 4. Audit topologico

Ãˆ stato costruito un grafo diagnostico non orientato sugli endpoint delle feature, arrotondati a 1 mm. Questa scelta serve solo a misurare la connettivitÃ  dichiarata dalle feature, non a imporre nuovi nodi agli incroci geometrici.
...
Lâ€™audit delle intersezioni geometriche ha contato:
- 126.373 intersezioni endpointâ€“endpoint;
- 42 endpointâ€“interior;
- 1.022 interiorâ€“interior;
- 1 coppia con overlap lineare;
- 1.064 punti potenzialmente non nodati in un grafo basato sui soli endpoint.

Molti esempi coinvolgono autostrade/raccordi e viabilitÃ  locale e possono essere correttamente separati in quota. Pertanto non Ã¨ ammissibile spezzare automaticamente tutte le intersezioni geometriche. Eventuali correzioni topologiche future devono distinguere incroci a raso, cavalcavia/sottopassi e duplicazioni.

## 5. Test di connettivitÃ  Light â€” solo sanity check

Ãˆ stato eseguito un test di raggiungibilitÃ  sul grafo non orientato, con peso pari alla lunghezza geometrica, usando sette probe territoriali: Pordenone, Udine, Gorizia, Trieste, Tolmezzo, Tarvisio e Lignano Sabbiadoro.

Tutte le coppie risultano raggiungibili nella componente operativa.

Esempi di distanza diagnostica:
- Pordenoneâ€“Udine: 49,86 km;
- Udineâ€“Gorizia: 36,84 km;
- Goriziaâ€“Trieste: 43,63 km;
- Udineâ€“Tarvisio: 87,78 km;
- Tolmezzoâ€“Tarvisio: 60,20 km.
...
## 6. DirezionalitÃ  â€” esito critico

### 6.1 DIR

DIR non Ã¨ un flag di senso unico.
...
DIR puÃ² contribuire alla lettura semantica della carreggiata, ma non puÃ² essere trasformato in un booleano one-way senza una regola documentata.
...
Nel materiale pubblico ispezionato non Ã¨ stata trovata una definizione affidabile dei codici 0/1/2 sufficiente per usarli come regola di percorrenza.

Inoltre la copertura Ã¨ incompatibile con un uso ingenuo come flag direzionale:
- A4: 162/162 NULL;
- A28: 109/109 NULL;
- A34: 45/47 NULL;
...
GEOMETRY_REVERSED distingue il verso geometrico di alcune feature, ma non prova da solo la legalitÃ  della percorrenza.

### 6.3 Conseguenza

Il grafo regionale Ã¨ idoneo come base geometrica e per screening di connettivitÃ  non orientata, ma NON Ã¨ ancora validato come rete di routing Light diretta/legalmente percorribile.
...
Conclusione: F3_SRC_FVG_ROADGRAPH_001 da solo non Ã¨ idoneo a routing Heavy di produzione.

Per una rete Heavy futura sarÃ  necessario sovrapporre almeno:
1. restrizioni strutturali permanenti;
2. ordinanze/restrizioni dei gestori;
3. eventuali limitazioni temporanee con data di validitÃ ;
4. compatibilitÃ  del singolo accesso e connector con il veicolo Heavy.

Non Ã¨ stata inventata alcuna restrizione mancante.

## 8. TEN-T corrente â€” gerarchia autorevole

La rete TEN-T vigente Ã¨ trattata secondo il Reg. (UE) 2024/1679 e la cartografia DG MOVE 2024 a tre livelli:
- core;
- extended core;
- comprehensive.
...
Lâ€™Annex I usa esplicitamente la legenda Roads Core / Roads Extended Core / Roads Comprehensive. Lâ€™Annex II identifica i nodi TEN-T.

Nel FVG lâ€™Annex II include, tra gli elementi rilevanti:
...
Per questo motivo non viene usato come fonte autorevole della tassonomia 2024 a tre livelli. Ãˆ conservato come evidenza/benchmark legacy.
...
Il servizio tentec_public_corridors_ext Ã¨ invece coerente con i European Transport Corridors 2024. I layer stradali dei corridoi Baltic Seaâ€“Adriatic Sea e Mediterranean interrogati sul FVG restituiscono feature con CORE_NETWORK=1.

Il crosswalk tecnico campionato con il grafo FVG associa in modo netto tali tratti, tra gli altri, ad A4, A23, RA13 e allâ€™asse di collegamento di Trieste/Fernetti.

Questo crosswalk Ã¨ corroborativo, non sostituisce una classificazione route-level completa dei tre livelli.
...
Non Ã¨ stato perÃ² individuato, nel mandato corrente, un layer pubblico REST unico che fornisca in modo direttamente interrogabile e documentato la completa classificazione core / extended core / comprehensive di ogni tratto stradale FVG.

Pertanto:
- non viene riciclata la tassonomia legacy a due livelli;
- non viene inferita la classe mancante per semplice prossimitÃ ;
- non viene dichiarato â€œnessun extended core in FVGâ€ per assenza nel subset dei corridoi;
- il crosswalk route-level completo rimane attivitÃ  successiva.

## 11. Uscite TEN-T â€” lineage futura

Le 23 uscite del progetto storico non vengono riutilizzate come insieme autorevole: la loro lineage non Ã¨ sufficiente.
...
- classe interpretativa dellâ€™elemento.

Per autostrade e strade a accesso controllato lâ€™uscita deve derivare da uno svincolo reale verificabile, non da ogni incrocio geometrico.

Per i tratti TEN-T ordinari a raso resta una questione metodologica sostanziale: come tradurre operativamente il concetto AFIR di â€œnearest exitâ€ quando non esiste uno svincolo autostradale univoco.

Q-METH-3.3-A â€” PROPOSED / da sottoporre alla Chat Madre e allâ€™utente:
definizione operativa di nearest TEN-T road exit sui tratti non a accesso controllato, senza alterare i limiti AFIR giÃ  FROZEN in Fase 1.

## 12. Data contract futuro per accessi e rete

Nessun record reale Ã¨ stato creato. Si definisce solo il contratto minimo coerente con F2-D4.
...
- note su legalitÃ /fattibilitÃ  fisica.

Sono ammessi piÃ¹ accessi per candidato. Lâ€™assenza di accessi validabili deve essere esplicita e non tradotta in eliminazione silenziosa.
...
Una distanza di ricerca futura Ã¨ un parametro da motivare e approvare; non viene fissata in questa chat.
...
- lunghezza;
- percorribilitÃ  Light/Heavy;
- natura pubblica/privata se disponibile;
- barrier/crossing flags;
- fonte/evidence;
- validation_status.

Il nearest road puÃ² al massimo proporre un anchor da verificare. Non prova lâ€™esistenza di un accesso fisico o legale.

## 13. Disposizione di ISS-0004

**Stato proposto: OPEN â€” delimitato con evidenza.**
...
Prossimo passo necessario: definire una sorgente/regola di direzionalitÃ  documentata e un layer di restrizioni Heavy prima dellâ€™uso per distanze AFIR definitive.
...
- [x] Geometria, validitÃ  e connettivitÃ  quantificate.
- [x] Dangling, componenti, micro-gap e crossing candidate quantificati.
- [x] DirezionalitÃ  non inferita da campi non documentati.
...
Il PASS significa che i due issue sono stati sufficientemente verificati e delimitati per la regia. Non significa che ISS-0004 o ISS-0005 siano risolti, nÃ© che la Fase 3 possa essere chiusa o congelata.

## 16. Artifact e riproducibilitÃ 
...
Output OneDrive:
- ROADGRAPH_AUDIT_METRICS_v01.json â€” SHA-256 324DBD888F4122425D6A2A449D7C67C8A90E712979EE04C25700099A481F01C0;
- ROADGRAPH_INTERSECTION_AUDIT_v01.json â€” 6E9E341818D9088D04BA78E438BFC04DF23B56F5C88408935B2B0D936EA71E5A;
- ROADGRAPH_NONNODED_INTERSECTION_EXAMPLES_v01.csv â€” 8D00DFB6DE92E6D89E63651D1ED92BA44B24F13758F4664CF5290577812DB2A1;
- ROADGRAPH_REACHABILITY_TEST_v01.json â€” F808B3F4B1021E63DA7F89A1C35AC76DB3D7E2358E0C3479C08F46335CC2B517;
- TENTEC_CORRIDOR_TO_FVG_ROAD_CROSSWALK_v01.csv â€” D85E45FBDDA39D76D2513546E395EEA5688AE8056EFB25FDCB33104A9DE4392B.
