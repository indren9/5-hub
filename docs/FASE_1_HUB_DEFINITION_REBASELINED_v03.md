...
**Data:** 2026-09-21
**Stato:** FROZEN — approvato esplicitamente dall'utente il 2026-09-21 — non sostituisce la v02 FROZEN finché l'utente non approva
...
Questa v03 è **FROZEN** ed è il successore metodologico operativo della v02 per il nuovo scope.

Con l'approvazione esplicita dell'utente:
1. è il successore metodologico della v02 per il nuovo scope;
